...
const char* mqtt_server = "broker.emqx.io";  // O tu broker MQTT
const int mqtt_port = 1883;
const char* mqtt_client_id = "ESP32_Temp_Controller";

// MQTT Topics
const char* mqtt_cmd_topic = "/casa/cmd";
const char* mqtt_temp_topic = "/casa/temperatura";
...
const long interval = 10000;  // Intervalo de publicación de temperatura (10 segundos)
...
void setup() {
  ...
  xTaskCreatePinnedToCore(
    ...
    8192,               // Aumentado el stack size para MQTT
 ...
 */
void updateDisplay() {
  // To be implemented with actual display code
